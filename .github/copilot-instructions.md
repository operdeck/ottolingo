# Ottolingo — GitHub Copilot instructions

> The canonical source of truth is **`AGENTS.md`** in the repo root.
> The content below is kept in sync with it so Copilot has it available
> in context without requiring a separate file read.
